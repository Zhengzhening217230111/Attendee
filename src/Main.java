...
public class Main {
   public static void main(String[]args)throws Exception{
    ...
    do{
        ...
        System.out.println("Type 2 to attendee names that are coming to the event:"+"\n");
        System.out.println("Type 3 to remove an attendee names that are coming to the event:"+"\n");
        System.out.println("Type 4 to update an attendee in the list:"+"\n");
        System.out.println("Type 5 to search for attendee in the list"+"\n");
